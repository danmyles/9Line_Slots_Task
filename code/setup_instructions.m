...
instructions.lines = {
    ...
    'Match 3 of any symbol and the machine will payout!'; ...
    'There are 9 different ways that a three symbol match can occur';
    };
...
instructions.betting = {
    ...
    'Your bet will cost more, but the winnings will be 10x larger';
    };
