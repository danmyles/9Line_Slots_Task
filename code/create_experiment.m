...
for i = 1:reelInfo.nTrials
    ...
    % Left
    outputEmpty(i, ismember(outputEmpty.Properties.VariableNames, patternL)) = ...
        array2table(reelInfo.reelstrip(expandStopINDEX(reelInfo, outputEmpty.LStop(i), 1, 1), 1)');
    
    % Right 
    outputEmpty(i, ismember(outputEmpty.Properties.VariableNames, patternR)) = ...
    ...
    outputEmpty.match(i) = ismember(outputEmpty.CS(i), ... 
        outputEmpty{i, ismember(outputEmpty.Properties.VariableNames, patternL)}(LIA));
