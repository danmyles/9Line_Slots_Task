...
Screen('TextSize', screenInfo.window, reelInfo.TextSize + 30);
...
DrawFormattedText(screenInfo.window, 'BLUE GAME', 'center', 'center', ...
    [],[],[],[],[],[],CenterRectOnPoint([0, 0, rectL(4) - rectL(2), 24], xLR(side(1)), rectL(2) + inset));

Screen('TextSize', screenInfo.window,  reelInfo.TextSize + 10);

DrawFormattedText(screenInfo.window, [num2str(reelInfo.lineBet(1) * 9), ' CREDITS PER SPIN '], 'center', 'center', ...
    [],[],[],[],[],[],CenterRectOnPoint([0, 0, rectL(4) - rectL(2), 24], xLR(side(1)), rectL(2) * 2 + inset));
...
DrawFormattedText(screenInfo.window, ['CHOSEN ', num2str(reelInfo.betAChoices), ' TIMES '], 'center', 'center', ...
    [],[],[],[],[],[],CenterRectOnPoint([0, 0, rectL(4) - rectL(2), 24], xLR(side(1)), rectL(2) * 4));

DrawFormattedText(screenInfo.window, [num2str(reelInfo.lineBet(1)), ' CREDITS x 9 LINES'], 'center', 'center', ...
    [],[],[],[],[],[],CenterRectOnPoint([0, 0, rectL(4) - rectL(2), 24], xLR(side(1)), screenInfo.yCenter));
...
DrawFormattedText(screenInfo.window, 'GREEN GAME', 'center', 'center', ...
    [],[],[],[],[],[],CenterRectOnPoint([0, 0, rectL(4) - rectL(2), 24], xLR(side(2)), rectL(2) + inset));

Screen('TextSize', screenInfo.window,  reelInfo.TextSize + 10);

DrawFormattedText(screenInfo.window, [num2str(reelInfo.lineBet(1) * 9), ' CREDITS PER SPIN '], 'center', 'center', ...
    [],[],[],[],[],[],CenterRectOnPoint([0, 0, rectL(4) - rectL(2), 24], xLR(side(2)), rectL(2) * 2 + inset));

Screen('TextSize', screenInfo.window, reelInfo.TextSize);

DrawFormattedText(screenInfo.window, ['CHOSEN ', num2str(reelInfo.betBChoices), ' TIMES '], 'center', 'center', ...
    [],[],[],[],[],[],CenterRectOnPoint([0, 0, rectL(4) - rectL(2), 24], xLR(side(2)), rectL(2) * 4));

DrawFormattedText(screenInfo.window, [num2str(reelInfo.lineBet(1)), ' CREDITS x 9 LINES'], 'center', 'center', ...
    [],[],[],[],[],[],CenterRectOnPoint([0, 0, rectL(4) - rectL(2), 24], xLR(side(2)), screenInfo.yCenter));
...
DrawFormattedText(screenInfo.window, 'PRESS LEFT', 'center', 'center', ...
    [],[],[],[],[],[],CenterRectOnPoint([0, 0, rectL(4) - rectL(2), 24], xL, rectL(2) * 4 + inset));
...
DrawFormattedText(screenInfo.window, 'PRESS RIGHT', 'center', 'center', ...
    [],[],[],[],[],[],CenterRectOnPoint([0, 0, rectL(4) - rectL(2), 24], xR, rectL(2) * 4 + inset));
