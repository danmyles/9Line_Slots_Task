...
reelInfo.payout.rect = reelInfo.baseRect .* (3/4);
% Size of smaller inset shape, needs to be divisible by 2
reelInfo.payout.small = reelInfo.payout.rect - (reelInfo.payout.rect/5);
reelInfo.payout.textSize = floor(reelInfo.baseRect(4)/4);
